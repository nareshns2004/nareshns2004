# 💫 Naresh Kumar:
Senior Software Development Engineer<br>Working on High Performance Computers<br>Computer Architecture Operating Systems<br>FullStack Web Development<br>LLMs as Operating Systems: MemGPT (Letta): Long Memory for AI Agents
